    ...
    namespace solvers{
        ...
        class Quick_solver{
            ...
            public:
                ...
                void eco_dynamics(float* S, float* I, float* H, int* exit_flag, float beta_max, float alpha_max, float sigma_max, float b, float q, float d, float rho, float eta, float gamma, float lambda, float c1, float c2, float hyper, int seed, float S_density, float I_density, float H_density);
