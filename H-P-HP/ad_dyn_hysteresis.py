...
plt.savefig("../supplementary_figures/ad_dyn_figure.png", bbox_inches='tight', dpi = 300)
plt.savefig("../supplementary_figures/ad_dyn_figure.pdf", bbox_inches='tight', dpi = 300)
plt.savefig("../supplementary_figures/ad_dyn_figure.tiff", bbox_inches='tight', dpi = 300)
plt.close()