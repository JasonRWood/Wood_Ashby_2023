...
plt.savefig("../supplementary_figures/branching_fig.pdf", bbox_inches = "tight", dpi = 600)
plt.savefig("../supplementary_figures/branching_fig.png", bbox_inches = "tight", dpi = 600)
plt.savefig("../supplementary_figures/branching_fig.tiff", bbox_inches = "tight", dpi = 600)
plt.close()